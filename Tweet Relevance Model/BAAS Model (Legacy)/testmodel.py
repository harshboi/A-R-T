###################################################################################################################
# Author: Rohan Varma
# This file gives various options for testing a saved pickle file for either a scikit-learn svm or logistic regression classifier.
# It provides an interactive command line tool that allows you to enter sentences or lets you provide in an array of text, encodings,
# and optionally labels, ultimately outputting a file that tabulates the model's predictions.
###################################################################################################################
