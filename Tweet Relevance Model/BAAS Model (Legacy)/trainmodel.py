###################################################################################################################
# Author: Rohan Varma
# This file trains a classification layer on top of the BERT encodings and provides performance metrics on the 
# training and optionally the testing set. It takes in the type of classifier to be trained as well as NumPy
# arrays for the training encodings and labels. Optionally, NumPy arrays for testing encodings and labels can be
# provided as well
###################################################################################################################
...
def main():
    ...
    if len(sys.argv) != 4 and len(sys.argv) != 6: 
        print("usage: trainmodel.py <classifier_type> <training_tweets> <training_labels> [test_tweets] [test_labels]")
        print("       Options for <classifier_type> are 'logistic', 'svm', or 'neural'")
    else:
